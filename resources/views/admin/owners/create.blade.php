...
@section('page-title', 'Tambah Owner Baru')
        ...
        <form action="{{ route('admin.owners.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <div class="flex items-start">
                    <i class="fas fa-crown text-purple-500 mt-1 mr-3"></i>
                    <div>
                        <h4 class="text-sm font-medium text-purple-900">Info Akun Owner</h4>
                        <p class="text-sm text-purple-700 mt-1">
                            Akun owner akan otomatis dibuat dengan role <strong>"Owner"</strong>.
                            Owner memiliki akses untuk melihat dashboard pemasukan dan laporan bisnis.
                        </p>
                    </div>
                </div>
            </div>
