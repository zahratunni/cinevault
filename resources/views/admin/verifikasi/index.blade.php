...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 mt-1">Kelola dan verifikasi pembayaran pelanggan</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="border-b border-gray-200">
            <nav class="flex -mb-px">
                ...
                <a href="{{ route('admin.verifikasi.index', ['status' => 'Lunas']) }}" 
                ...
                <a href="{{ route('admin.verifikasi.index', ['status' => 'Gagal']) }}" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                @if($pembayaran->status_pembayaran == 'Pending')
                                    <a href="{{ route('admin.verifikasi.show', $pembayaran->pembayaran_id) }}" 
