        ...
        <form action="{{ route('admin.films.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0">
                        <img id="posterPreview" src="https://via.placeholder.com/150x200?text=Poster" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="rating" required
                        ...
                        <option value="17+" {{ old('rating') == '17+' ? 'selected' : '' }}>17+</option>
                        <option value="21+" {{ old('rating') == '21+' ? 'selected' : '' }}>21+</option>
                    </select>
                    @error('rating')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="status_tayang" required
                        ...
                        <option value="Selesai" {{ old('status_tayang') == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                    </select>
                    @error('status_tayang')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="produser" value="{{ old('produser') }}"
                ...
                <div>
                    ...
                    <input type="text" name="sutradara" value="{{ old('sutradara') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="produksi" value="{{ old('produksi') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
                ...
                <textarea name="cast_list" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Pisahkan dengan koma. Contoh: Robert Downey Jr., Chris Evans, Scarlett Johansson">{{ old('cast_list') }}</textarea>
